...
namespace Fighting
{
    public class Block
    {
        ...
        public double BoxerPunchesPerRound(FighterState boxer)
        {
            ...
            double punchMean = boxer.PunchCapacity();
        ...
        public double JabPercentages(FighterState fighter, FighterState opponent)
        {
            ...
            //Figher jab percent effected by preferred distance and what distance fight is at
